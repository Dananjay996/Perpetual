...
contract EverSwap is ERC4626{
    ...
    IERC20 private asset = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    ...
    constructor(uint256 initialValue_) ERC4626(asset) ERC20("EverSwap", "ESW"){

    }

    function totalAssets() public override view returns(uint256){
        require(int256(asset.balanceOf(address(this))) >= currentPnL, "EverSwap: Insufficient funds to cover PnL");
        int256 currentLPValue = int256(asset.balanceOf(address(this))) - currentPnL;
